...
require (
	...
	github.com/cockroachdb/pebble v0.0.0-20230512205950-e9005aede63f
	github.com/coffeehc/base v1.0.0
	github.com/coffeehc/boot v0.0.0-20220918165431-7e1663746e60
	github.com/coffeehc/httpx v0.0.0-20220806074441-2cec2ea644ba
